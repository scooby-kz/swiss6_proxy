...
const upgradedSwisstronik = await upgrades.deployProxy(Swisstronik, ['Hello Swisstronik from PyDragonX!!'], { kind: 'transparent' });
...
const messageToSet = "Hello Swisstronik from PyDragonX!!";
...
echo "Done! Subscribe: Follow @Py-DragonXx on github"
